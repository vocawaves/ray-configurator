...
description = {
    ...
    'SUN_SHADOW_MAP_QUALITY': 'Quality of the sun shadow map.',
    'SUN_SHADOW_SAMPLE_QUALITY': 'Quality of the sun shadow samples.',
    ...
    'FOG_ENABLE': 'Enable the fog tab.',
    'OUTLINE_QUALITY': 'Quality of the outline.',
    'TOON_ENABLE': 'Enable the toon shading material.',
    'SSDO_QUALITY': 'Quality of the horizon based ambient occlusion plus (SSDO).',
    'SSR_QUALITY': 'Quality of the screen space reflection.',
    'SSSS_QUALITY': 'Enable the subsurface scattering.',
    'SSGI_QUALITY': 'Quality of the screen space global illumination.',
    'BOKEH_MODE': 'Quality of the bokeh depth of field.',
    'EYE_ADAPTATION': 'Quality of the eye adaptation.',
    'BLOOM_MODE': 'Enable the bloom.',
    'BLOOM_DIRT_ENABLE': 'Enable the bloom dirt mask.',
    'HDR_STAR_MODE': 'Quality of the lens flare/star.',
    'HDR_TONEMAP_OPERATOR': 'Quality of the tonemapper.',
    'AA_QUALITY': 'Quality of the anti-aliasing.',
    'POST_DISPERSION_MODE': 'Quality of the post dispersion.',
}
